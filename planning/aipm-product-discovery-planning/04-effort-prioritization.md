...
| Explainable results + validation pack | 4 days | ✅ MUST HAVE | Reviewers need trust, explainability, and capstone-ready evidence in one place |
| CSV upload | 3 days | ⚙️ SHOULD HAVE | Improves workflow fit but is not required to prove value |
| Simple scenario comparison | 3 days | ⚙️ SHOULD HAVE | Valuable for founders and PMs, but secondary to core forecast trust |
...
- Explainable results + validation pack: `4`

Committed total: `15 team days`

Reserved buffer:
- Integration and QA: `1.5 days`
- Demo rehearsal and issue fixing: `1.5 days`
...
| Outcome Goal | Epic | Deliverables |
|--------------|------|--------------|
| Improve timeline decision confidence with explainable risk forecasting | Epic A - Guided intake | Brief form, task generation prompt, schema validation, editable task table |
| Improve timeline decision confidence with explainable risk forecasting | Epic B - Forecast engine | DAG builder, Monte Carlo engine, metrics module, risk dashboard |
| Improve timeline decision confidence with explainable risk forecasting | Epic C - Explainable results and validation | Executive summary, methodology note, model comparison, capstone evidence docs |
